...
<div class="space-y-6">
    ...
    <x-card>
        <div class="flex items-center justify-between gap-3">
            <div>
                <h3 class="text-base font-semibold text-gray-900">Report Preview</h3>
                <p class="text-sm text-gray-500">Overview by date and validation status.</p>
            </div>
            <x-button type="button" x-on:click="$dispatch('notify', { message: 'Export PDF started', type: 'success' })">Export PDF</x-button>
        </div>

        <div class="mt-4">
            <x-table :headers="['Date', 'Total Check-In', 'Valid GPS', 'Invalid GPS']">
                <tr class="bg-white">
